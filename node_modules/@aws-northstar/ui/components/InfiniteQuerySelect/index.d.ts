 ...
 */
export interface InfiniteQuerySelectProps<TItem, K extends string, TExtendedItem extends TItem, TError> extends Omit<SelectProps, 'options' | 'onLoadItems' | 'statusType'> {
    /**
 ...
 */
declare const InfiniteQuerySelect: <TItem, K extends string, TExtendedItem extends TItem, TError>({ query, itemsKey, toOption, extendData, ...props }: InfiniteQuerySelectProps<TItem, K, TExtendedItem, TError>) => JSX.Element;
