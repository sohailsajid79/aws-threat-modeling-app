...
class ItemsPaletteWrapper extends dom_1.ComponentWrapper {
    ...
    findItemById(itemId) {
        return this.findComponent(`[data-item-id="${itemId}"]`, palette_item_1.default);
    }
}
exports.default = ItemsPaletteWrapper;
ItemsPaletteWrapper.rootSelector = styles_selectors_js_1.default.root;
