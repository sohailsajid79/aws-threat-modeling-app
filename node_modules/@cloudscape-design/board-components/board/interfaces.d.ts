...
export declare namespace BoardProps {
    ...
    interface DndInsertState<D> {
        item: Item<D>;
        placement: ItemPlacement;
        conflicts: readonly Item<D>[];
        disturbed: readonly Item<D>[];
    }
    interface DndResizeState<D> {
        item: Item<D>;
        placement: ItemPlacement;
        direction: "horizontal" | "vertical";
...
export type TransitionAnnouncement = DndStartedAnnouncement | DndActionAnnouncement | DndCommittedAnnouncement | DndDiscardedAnnouncement | ItemRemovedAnnouncement;
