...
export const Label = ({ label, prefix, highlightText, triggerVariant }) => (React.createElement("span", { className: clsx(styles.label, analyticsSelectors.label, triggerVariant && styles['trigger-variant']) },
