...
const styles_selectors_js_1 = require("../../../internal/components/cartesian-chart/styles.selectors.js");
...
const styles_selectors_js_4 = require("../../../mixed-line-bar-chart/styles.selectors.js");
class BaseCartesianChartWrapper extends charts_1.default {
     ...
     */
    findSeries() {
        return this.findAllByClassName(styles_selectors_js_4.default.series);
    }
    findHighlightedSeries() {
        return this.findByClassName(styles_selectors_js_4.default['series--highlighted']);
    }
    findXAxisTitle() {
        return this.findByClassName(styles_selectors_js_1.default['axis-label--x']);
    }
    findYAxisTitle() {
        return this.findByClassName(styles_selectors_js_1.default['axis-label--y']);
    }
    findXTicks() {
        return this.findAllByClassName(styles_selectors_js_1.default['ticks--x']);
    }
    findYTicks() {
        return this.findAllByClassName(styles_selectors_js_1.default['ticks--y']);
    }
}
...
class MixedLineBarChartWrapper extends BaseCartesianChartWrapper {
     ...
     */
    findBarGroups() {
        return this.findAllByClassName(styles_selectors_js_4.default['bar-group']);
    }
}
exports.default = MixedLineBarChartWrapper;
MixedLineBarChartWrapper.rootSelector = styles_selectors_js_4.default.root;
