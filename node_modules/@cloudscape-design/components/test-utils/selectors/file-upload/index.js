...
const styles_selectors_js_1 = require("../../../file-upload/file-input/styles.selectors.js");
const styles_selectors_js_2 = require("../../../file-upload/file-option/styles.selectors.js");
...
class FileUploadWrapper extends selectors_1.ComponentWrapper {
    findUploadButton() {
        return this.findComponent(`.${styles_selectors_js_1.default['upload-button']}`, button_1.default);
    }
    findNativeInput() {
        return this.findByClassName(styles_selectors_js_1.default['upload-input']);
    }
    findFileTokens() {
        return this.findAllByClassName(styles_selectors_js_6.default.token).map(tokenElement => new FileTokenWrapper(tokenElement.getElement()));
    }
    /**
    ...
    findFileToken(fileTokenIndex) {
        return this.findComponent(`.${styles_selectors_js_6.default.token}[data-index="${fileTokenIndex - 1}"]`, FileTokenWrapper);
    }
    /**
...
class FileTokenWrapper extends selectors_1.ComponentWrapper {
    ...
    findFileThumbnail() {
        return this.findByClassName(styles_selectors_js_2.default['file-option-thumbnail-image']);
    }
    findFileError() {
        return this.find(`.${styles_selectors_js_4.default.error} .${styles_selectors_js_4.default.error__message}`);
    }
    findFileWarning() {
        return this.find(`.${styles_selectors_js_4.default.warning} .${styles_selectors_js_4.default.warning__message}`);
    }
    findRemoveButton() {
