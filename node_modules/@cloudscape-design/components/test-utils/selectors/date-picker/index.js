...
const styles_selectors_js_2 = require("../../../date-picker/styles.selectors.js");
class DatePickerWrapper extends base_input_1.default {
    ...
    findCalendar(options = {
        ...
        return wrapper.findComponent(`.${styles_selectors_js_1.default.root}`, calendar_1.default);
    }
    ...
    findOpenCalendarButton() {
        return this.findComponent(`.${styles_selectors_js_2.default['open-calendar-button']}`, button_1.default);
    }
}
exports.default = DatePickerWrapper;
DatePickerWrapper.rootSelector = styles_selectors_js_2.default.root;
