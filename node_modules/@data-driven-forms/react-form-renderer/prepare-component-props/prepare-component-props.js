...
var prepareComponentProps = function prepareComponentProps(_ref) {
  ...
  if ((0, _typeof2["default"])(componentBinding) === 'object' && Object.prototype.hasOwnProperty.call(componentBinding, 'component')) {
    var _component = componentBinding.component,
        mapperProps = (0, _objectWithoutProperties2["default"])(componentBinding, _excluded);
  ...
  if (componentProps.actions) {
    Object.keys(componentProps.actions).forEach(function (prop) {
      var _componentProps$actio = (0, _toArray2["default"])(componentProps.actions[prop]),
          action = _componentProps$actio[0],
          args = _componentProps$actio.slice(1);

      overrideProps[prop] = actionMapper[action].apply(actionMapper, (0, _toConsumableArray2["default"])(args));
...
var _default = prepareComponentProps;
