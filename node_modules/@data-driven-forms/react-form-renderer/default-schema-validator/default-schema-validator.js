...
var checkMappedAttributes = function checkMappedAttributes(condition) {
  ...
  if (condition.hasOwnProperty('mappedAttributes') && (0, _typeof2["default"])(condition.mappedAttributes) === 'object' && !Array.isArray(condition.mappedAttributes) && condition.mappedAttributes !== null) {
